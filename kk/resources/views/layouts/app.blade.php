...
<body>
    <section class="menu1" id="menu-0" data-rv-view="44">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    @foreach($temasTodos as $tema)
                                        ...
                                        {{-- <a class="dropdown-item" href="{{ url('/tema/'.$tema) }}">{{ $tema->nombre }}</a> --}}
                                    ...
                                    {{-- <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-submenu">
                                            <a class="dropdown-item" href="https://mobirise.com/">Image/content slider</a><a class="dropdown-item" href="https://mobirise.com/">Contact forms</a>
                                        </div>
                                    </div> --}}
                                </div>
                            </li>
